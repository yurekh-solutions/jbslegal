    ...
    >
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div
            ref={borderRef}
            className="relative rounded-[32px] p-[1px] bg-gradient-to-br from-blue-500/20 via-transparent to-cyan-500/20"
            style={{
          ...
          >
            ...
            <div className="relative rounded-[32px] bg-[#0E1420]/90 backdrop-blur-xl border border-white/5 overflow-hidden">
              {/* Inner glow effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-cyan-500/5" />

              {/* Content */}
              <div className="hero-content relative px-8 py-16 md:px-16 md:py-20 lg:px-20 lg:py-24">
                <div className="text-center space-y-8 max-w-4xl mx-auto">
                  {/* Top badge */}
                  <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 backdrop-blur-sm">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span>
                    </span>
                    <span className="text-blue-300 text-sm font-medium">
                      JBS Legal – IT Staffing and Recruitment, Solution
                    </span>
